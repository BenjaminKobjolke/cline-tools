...
class InputHandler:
    ...
    @staticmethod
    def get_valid_selection(files: List[str], prompt: str, allow_empty: bool = False) -> Optional[str]:
        """
    ...
    @staticmethod
    def display_files_with_numbers(files: List[str], category: str, start_num: int = 1) -> int:
        """
